 ...
 */
final class Version20231116010103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal (id INT AUTO_INCREMENT NOT NULL, animalbatch_id INT DEFAULT NULL, nutritional_needs_id INT DEFAULT NULL, ration_id INT DEFAULT NULL, gestation_id INT DEFAULT NULL, espece VARCHAR(255) NOT NULL, sexe VARCHAR(255) NOT NULL, poids DOUBLE PRECISION DEFAULT NULL, age VARCHAR(255) NOT NULL, INDEX IDX_6AAB231F809303D (animalbatch_id), INDEX IDX_6AAB231F90D0435D (nutritional_needs_id), INDEX IDX_6AAB231F4A5A89FC (ration_id), UNIQUE INDEX UNIQ_6AAB231FC4ABA3D1 (gestation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE maintenance (id INT AUTO_INCREMENT NOT NULL, materiel_type VARCHAR(100) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, description VARCHAR(200) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

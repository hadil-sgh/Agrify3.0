...
use App\Repository\BesoinNutritionnelsEntityRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: BesoinNutritionnelsEntityRepository::class)]
class BesoinNutritionnelsEntity
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
